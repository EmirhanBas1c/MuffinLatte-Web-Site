  ...
  return (
    <div>
     <h2 className="mt-4 text-white font-bold text-3xl">Terms of Services</h2>
      <p className="text-sm text-white/30 mb-1">Last Update: 30/07/2024 🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
<p>⊳ Every discord server can use the MuffinLatte bot for free, it is completely prohibited to sell or market for a fee.</p>
...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/1252146752186749021">MuffinLatte</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
